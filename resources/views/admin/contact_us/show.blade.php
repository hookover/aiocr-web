                ...
                <div class="card-header">
                    ...
                    <div class="category">
                       <a href="{{ url('/admin/contact_us') }}" title="Back"><button class="btn btn-warning btn-xs"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                                               <a href="{{ url('/admin/contact_us/' . $contact_us->id . '/edit') }}" title="Edit contact_us"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                               {!! Form::open([
                                                   'method'=>'DELETE',
                ...
                <div class="card-content">
                                    <div class="form-horizontal row">
                                        <div class="col-lg-6">
                                            ...
                                            @foreach($contact_us->toArray() as $key=>$value)
