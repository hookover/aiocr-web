...
<div class="form-group {{ $errors->has('point_pay_total') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('point_locked') ? 'has-error' : ''}}">
    {!! Form::label('point_locked', 'Point Locked', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('point_locked', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
        {!! $errors->first('point_locked', '<p class="help-block">:message</p>') !!}
    </div>
    ...
    <div class="col-md-6">
        {!! Form::number('status_account', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
        {!! $errors->first('status_account', '<p class="help-block">:message</p>') !!}
    </div>
</div><div class="form-group {{ $errors->has('count_login') ? 'has-error' : ''}}">
    {!! Form::label('count_login', 'Count Login', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::number('count_login', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
