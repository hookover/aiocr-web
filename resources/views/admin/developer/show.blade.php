                ...
                <div class="card-header">
                    ...
                    <div class="category">
                       <a href="{{ url('/admin/developer') }}" title="Back"><button class="btn btn-warning btn-xs"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                                               <a href="{{ url('/admin/developer/' . $developer->id . '/edit') }}" title="Edit developer"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                               {!! Form::open([
                                                   'method'=>'DELETE',
                ...
                <div class="card-content">
                                    <div class="form-horizontal row">
                                        <div class="col-lg-6">
                                            ...
                                            @foreach($developer->toArray() as $key=>$value)
